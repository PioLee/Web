...
<script>
  export default {
    ...
    methods: {
      onSubmit() {
        // this.modelData.manufacturer = this.manufacturers.find(item => item.name === this.modelData.manufacturer.name);
        this.modelData.manufacturer = this.modelData.manufacturer.name
